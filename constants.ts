...
export const TURKEY_CENTER_LAT = 39.9334;
export const TURKEY_CENTER_LNG = 32.8597;
export const DEFAULT_ZOOM = 6;

// Comprehensive list of 81 Provinces with approximate center coordinates
export const PROVINCES: Province[] = [
  ...
  { id: 5, name: "Amasya", lat: 40.6501, lng: 35.8353 },
  ...
  { id: 9, name: "Aydın", lat: 37.8444, lng: 27.8458 },
  { id: 10, name: "Balıkesir", lat: 39.6484, lng: 27.8826 },
  { id: 11, name: "Bilecik", lat: 40.1451, lng: 29.9799 },
  ...
  { id: 15, name: "Burdur", lat: 37.7204, lng: 30.2908 },
  ...
  { id: 22, name: "Edirne", lat: 41.6768, lng: 26.5603 },
  ...
  { id: 29, name: "Gümüşhane", lat: 40.4600, lng: 39.4700 },
  { id: 30, name: "Hakkâri", lat: 37.5833, lng: 43.7333 },
  { id: 31, name: "Hatay", lat: 36.4018, lng: 36.3498 },
  { id: 32, name: "Isparta", lat: 37.7648, lng: 30.5566 },
  { id: 33, name: "Mersin", lat: 36.8000, lng: 34.6333 },
  { id: 34, name: "İstanbul", lat: 41.0082, lng: 28.9784 },
  { id: 35, name: "İzmir", lat: 38.4192, lng: 27.1287 },
  ...
  { id: 42, name: "Konya", lat: 37.8667, lng: 32.4833 },
  ...
  { id: 72, name: "Batman", lat: 37.8812, lng: 41.1265 },
  { id: 73, name: "Şırnak", lat: 37.5164, lng: 42.4611 },
  { id: 74, name: "Bartın", lat: 41.6344, lng: 32.3375 },
  { id: 75, name: "Ardahan", lat: 41.1105, lng: 42.7022 },
  { id: 76, name: "Iğdır", lat: 39.9975, lng: 44.0450 },
